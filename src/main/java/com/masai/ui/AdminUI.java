...
static void addCrime(Scanner sc) {
	...
	sc.nextLine();
	System.out.print("Please Enter Crime Description");
	...
	System.out.print("Choose Police station id");
	int psid = sc.nextInt();
	...
	sc.nextLine();
	System.out.print("PLease enter police station area");
	String psAreaName = sc.nextLine();
	PsArea psa = new PsArea(psAreaName,ps,null);
	
	System.out.print("PLease enter drime date in (dd-mm-yyyy) formate");
	DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
	Date date =Date.valueOf(LocalDate.parse(sc.next(), formatter));
	sc.nextLine();
	System.out.print("Plese enter the victim name");
...
private static void updateCrimeDate(Scanner sc) {
    ...
    int id = sc.nextInt();
    System.out.print("Please enter crime date in (DD-MM-YYYY) formate");
	DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
	Date date =Date.valueOf(LocalDate.parse(sc.next(), formatter));
...
private static void updateCrimePsArea(Scanner sc) {
    ...
    int id = sc.nextInt();
    sc.nextLine();
    System.out.print("Enter new Police Station Area");
